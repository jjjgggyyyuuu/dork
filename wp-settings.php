...
// Load theme's functions.php if it exists
if ( file_exists( ABSPATH . 'wp-content/themes/domain-valuator/functions.php' ) ) {
    require_once ABSPATH . 'wp-content/themes/domain-valuator/functions.php';
}

// Load plugin's main file if it exists
if ( file_exists( ABSPATH . 'wp-content/plugins/domain-valuator/domain-valuator.php' ) ) {
    require_once ABSPATH . 'wp-content/plugins/domain-valuator/domain-valuator.php';
}
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo 'wp-content/themes/domain-valuator/style.css'; ?>">
    <link rel="stylesheet" href="<?php echo 'wp-content/plugins/domain-valuator/assets/css/domain-valuator.css'; ?>">
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/chart.js@3.7.1/dist/chart.min.js"></script>
    <script src="<?php echo 'wp-content/plugins/domain-valuator/assets/js/domain-valuator.js'; ?>"></script>
    <style>
        body {
